package com.itwangpt.travel.utils;
...
public class MailUtil {
    ...
    public static void main(String[] args) throws Exception {
        MailUtil.sendEmail("yinshiteng@itcast.cn", "<h2>恭喜您，注册成功！</h2><a href=http://localhost:8080/userServlet?requestMethod=active&code=123>请点击次链接进行激活</a>");
    }
}
